...
$modules['02_cat_and_goods']['00_material_list']       = 'material.php?act=list';      // 面料列表
$modules['02_cat_and_goods']['00_material_add']        = 'material.php?act=add';       // 添加面料
...
$modules['03_agency_and_dealer']['agency_list']     = 'agency.php?act=list';
$modules['03_agency_and_dealer']['dealer_list']     = 'dealer.php?act=list';
$modules['03_agency_and_dealer']['dealer_add']     = 'dealer.php?act=add';
...
$modules['05_banner']['cat_list']                    = 'ads.php?act=cat_edit';
...
$modules['17_search']['19_search_list']         = 'search_list.php?act=list';
$modules['17_search']['20_search_add']          = 'search_list.php?act=add'
?>
