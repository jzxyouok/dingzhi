...
elseif ($_REQUEST['act'] =='insert')
{
    ...
    $info = array('package_price'=>$_POST['package_price']);
     /*处理图片*/
    $package_img = basename($image->upload_image($_FILES['package_img'],'package_img'));
    /* 插入数据 */
    $record = array('package_img'=>$_POST['package_img'],'package_title' => $_POST['package_title'],'act_name'=>$_POST['package_name'], 'act_desc'=>$_POST['desc'],
...
elseif ($_REQUEST['act'] =='update')
{
    ...
    $info = array('package_price'=>$_POST['package_price']);
     ...
     /*处理图片*/
    $package_img = basename($image->upload_image($_FILES['package_img'],'package_img',$_FILES['old_package_img']));
    /* 更新数据 */
	if($package_img){
		$record = array('package_img' => $package_img,'package_title' => $_POST['package_title'], 'act_name' => $_POST['package_name'],'start_time' => $_POST['start_time'], 'end_time' => $_POST['end_time'],
                    'act_desc' => $_POST['desc'], 'ext_info'=>serialize($info));
	}else{
		$record = array('act_name' => $_POST['package_name'],'package_title' => $_POST['package_title'], 'start_time' => $_POST['start_time'], 'end_time' => $_POST['end_time'],
                    'act_desc' => $_POST['desc'], 'ext_info'=>serialize($info));
